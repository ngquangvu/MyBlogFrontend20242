      ...
      <Dialog as="div" className="relative z-[70]" initialFocus={cancelButtonRef} onClose={closeModal}>
        ...
        <div className="fixed inset-0 z-60 overflow-y-auto">
          ...
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel
                className={`${classNames} relative transform overflow-hidden rounded-xl bg-white dark:bg-gray-800 px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6`}
              >
                {/* Content */}
                <div>{children}</div>
