...
export default function Photography() {
  ...
  return (
    <Container className='sm:px-8 mt-16 sm:mt-28'>
      <div>
        <SectionTitle title='Some photos I took.' intro='I love taking photos everywhere I go. Here are some of my favorite shots, almost all of them taken with my iPhone 7 Plus.' />
